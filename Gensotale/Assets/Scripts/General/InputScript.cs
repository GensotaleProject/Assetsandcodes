...
public class InputScript : MonoBehaviour {
    ...
    private Vector2 previousDirectionalInput;
    ...
    {
        bool leftDir = Input.GetKey(directionLeftInput);
        bool rightDir = Input.GetKey(directionRightInput);
        bool upDir = Input.GetKey(directionUpInput);
        bool downDir = Input.GetKey(directionDownInput);

        directionalInput = new Vector2((leftDir && rightDir) || !(leftDir || rightDir) ? 0 : (leftDir ? -1 : 1),
            (downDir && upDir) || !(downDir || upDir) ? 0 : (downDir ? -1 : 1));
    ...
    {
        bool leftDir = ((!leftIsAxis) ? Input.GetKey(directionLeftAxis) :
            ...
            //if negative, find if value is less than 0
            Input.GetAxisRaw(directionLeftAxis.Remove(directionLeftAxis.Length - 1)) < 0));

        bool rightDir = //Check if the right direction works off an axis
            ...
            //if negative, find if value is less than 0
            Input.GetAxisRaw(directionRightAxis.Remove(directionRightAxis.Length - 1)) < 0));

        bool downDir = //Check if the down direction works off an axis
            ...
            //if negative, find if value is less than 0
            Input.GetAxisRaw(directionDownAxis.Remove(directionDownAxis.Length - 1)) < 0));

        bool upDir = //Check if the up direction works off an axis
            ...
            //if negative, find if value is less than 0
            Input.GetAxisRaw(directionUpAxis.Remove(directionUpAxis.Length - 1)) < 0));
    ...
    {
        directionDown = new Vector2(((previousDirectionalInput.x == 0 && directionalInput.x != 0) || (previousDirectionalInput.x > 0 && directionalInput.x < 0) || (previousDirectionalInput.x < 0 && directionalInput.x > 0)) ? Mathf.Sign(directionalInput.x) : 0, 
            ((previousDirectionalInput.y == 0 && directionalInput.y != 0) || (previousDirectionalInput.y > 0 && directionalInput.y < 0) || (previousDirectionalInput.y < 0 && directionalInput.y > 0)) ? Mathf.Sign(directionalInput.y) : 0);

        directionUp = new Vector2(((previousDirectionalInput.x != 0 && directionalInput.x == 0) || (previousDirectionalInput.x > 0 && directionalInput.x < 0) || (previousDirectionalInput.x < 0 && directionalInput.x > 0)) ? Mathf.Sign(previousDirectionalInput.x) : 0, 
            ((previousDirectionalInput.y != 0 && directionalInput.y == 0) || (previousDirectionalInput.y > 0 && directionalInput.y < 0) || (previousDirectionalInput.y < 0 && directionalInput.y > 0)) ? Mathf.Sign(previousDirectionalInput.y) : 0);
